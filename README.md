...
> Not: API key, veritabanı şifresi ve benzeri gizli bilgiler public repository içerisine eklenmemelidir.
...
Eğer `docker-compose.yml` içerisinde backend servis adı farklı tanımlandıysa, yukarıdaki komutta `backend` yerine ilgili servis adı kullanılmalıdır.
